<template>
    ...
    <v-app>
        ...
        <template>
          ...
          >
            <v-card>
              <v-card-title class="headline" justify="center">POST BLOG</v-card-title>
              <v-card-text>
                <template>
                  <div>
                    <v-text-field label="Please Input Title" :rules="rules" hide-details="auto"></v-text-field>
                    <v-text-field label="Please Input Content"></v-text-field>
                  </div>
                </template>
              </v-card-text>

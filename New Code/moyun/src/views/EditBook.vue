			...
			<v-container>
				<el-form ref="form" :rules="rules" :model="form"  label-width="380px">
					<v-cintainer>
						...
						<el-form-item>
							<el-button type="primary" @click="onEdit('form')">保存编辑</el-button>
							<el-button type="primary" @click="onEditAndCheck('form')">保存编辑并查看</el-button>
							<el-button type="primary" @click="cancel">取消编辑并返回</el-button>
						</el-form-item>
					</v-cintainer>
				</el-form>
			</v-container>

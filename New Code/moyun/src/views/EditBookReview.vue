				...
				<div class="card">
					<div class="front">
						<v-form ref="form" v-model="valid" lazy-validation>
							<v-container fluid>
								<v-col cols="12">
									<v-text-field color="blue darken-2" v-model="title" :counter="20" required
										:rules="titleRules" label="书评题目"></v-text-field>
									<v-textarea color="teal" v-model="content" :counter="300" required
										:rules="contentRules">

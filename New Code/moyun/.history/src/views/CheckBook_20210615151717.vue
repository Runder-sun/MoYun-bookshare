    ...
    <v-app>
      ...
      <v-container>  
          ...
          <el-button type="danger" round @click="downloadBook">下载</el-button>
            ...
            <v-card-subtitle class="pb-0 text-right" style="padding:-5px">
              <p>出版社</p>
              <p>ISBN号</p>
            </v-card-subtitle>
            ...
            <v-card-text class="text--primary">
              ...
              <div>这是一段很长的测试用的简介所以不用看了谢谢 这是一段很长的测试用的简介所以不用看了谢谢 这是一段很长的测试用的简介所以不用看了谢谢 这是一段很长的测试用的简介所以不用看了谢谢 这是一段很长的测试用的简介所以不用看了谢谢 这是一段很长的测试用的简介所以不用看了谢谢 </div>
        </v-card-text>

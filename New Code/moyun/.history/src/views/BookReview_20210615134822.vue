              ...
              <v-tab-item>
                <v-container class="pa-4 text-center">
                  <v-row class="fill-height" align="center" justify="center">
                    <v-container>
                      <el-table :data="commentsData" style="width: 100%" height="250">
                        <el-table-column fixed prop="date" label="发布日期" width="150" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column prop="title" label="题目" width="120" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column prop="author" label="作者" width="120" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column prop="bookReview" label="书评内容" width="120" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column prop="scores" label="评分" width="300" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column align="right" :header-cell-style="{'text-align':'center'}"
              ...
              <v-tab-item>
                <v-container class="pa-4 text-center">
                  <v-row class="fill-height" align="center" justify="center">
                    <v-container>
                      <v-toolbar>
                        <v-toolbar-title>我的书评列表</v-toolbar-title>
                        <v-spacer></v-spacer>
                      </v-toolbar>
                      <el-table :data="commentsData" style="width: 100%" height="250">
              ...
              <v-tab-item>
                <v-container class="pa-4 text-center">
                  <v-row class="fill-height" align="center" justify="center">
                    <v-container>
                      <v-toolbar>
                        <v-toolbar-title>收藏书评列表</v-toolbar-title>
                        <v-spacer></v-spacer>
                      </v-toolbar>
                      <el-table :data="commentsData" style="width: 100%" height="250" >
                        <el-table-column fixed prop="date" label="发布日期" width="150"></el-table-column>

        ...
        <v-container class="pa-4 text-center">
          <v-col class="fill-height flex-column box" align="center" justify="space-between">
            <v-btn class="block" fab dark large color="primary" v-on:click="toBlock">
              ...
              <el-tabs tab-position="left" style="height: 1000px;" class="sideChoice">
                <el-tab-pane label="BookReviews">
                  <template>
              <v-item v-for="(item, index) in news" v-bind:key="index">
                <div>
                  ...
                  <el-tab-pane label="BookReviews">书评</el-tab-pane>
              </el-tabs>
              </template>

<template>
  <div class="BookReview">
    ...
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column prop="title" label="题目" width="150" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column prop="author" label="作者" width="150" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>
                        <el-table-column prop="bookReview" label="书评内容" width="150" :header-cell-style="{'text-align':'center'}"
    :cell-style="{'text-align':'center'}"></el-table-column>

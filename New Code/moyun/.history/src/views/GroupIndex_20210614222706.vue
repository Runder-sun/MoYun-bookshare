    ...
    <v-container>
      <v-card class="mx-auto" >
        ...
        <v-list-item three-line>
          ...
          <v-list-item-content>
            <div class="headline mb-4" style="margin-left:60px">{{group.groupName}}</div>
            <v-list-item-title style="margin-left:60px"> {{group.tag}}</v-list-item-title>
            <v-list-item-subtitle style="margin-left:60px">{{group.introduce}}</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>

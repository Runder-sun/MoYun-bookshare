    ...
    <v-container>
      <v-card class="mx-auto" >
        ...
        <v-list-item three-line>
          ...
          <v-list-item-content>
            <div class="headline mb-4" style="margin-left:30px">{{group.groupName}}</div>
            <v-list-item-title class="text-center"> {{group.tag}}</v-list-item-title>
            <v-list-item-subtitle class="text-center">{{group.introduce}}</v-list-item-subtitle>
          </v-list-item-content>
        </v-list-item>

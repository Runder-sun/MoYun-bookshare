    ...
    <v-main >
      <v-container fluid >
        ...
        <v-row class="fill-height main" align="center" justify="center">
            ...
            <v-tabs margin-top="70px" background-color="transparent">
              <v-tab>日志</v-tab>
              <v-tab>书评</v-tab>
              <v-tab-item class="main" color="transparent">
                <br>
                <br>
                <v-lazy background-color="transparent">
                  <v-container class="pa-4 text-center main" >

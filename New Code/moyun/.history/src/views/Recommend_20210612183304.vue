<template>
  <v-app class="rec">
      ...
      <v-row>
      <sideBar></sideBar>
      <v-container class="pa-4 text-center" style="margin-top:80px" color="transparent" justify="space-around" width="1300px" height="1000px" rounded>
        ...
        >
          ...
          <v-tab class="font-weight-black">书籍</v-tab>
           ...
           <v-tab-item>
            <v-container class="pa-4 text-center" margin-left="10px">
...
import sideBar from"../components/MSGSideBar.vue";
  export default {
    ...
    methods :{
      toRecFroup(){
        this.$router.push({path:"/Group/GroupIndex/"})
      },
      toRecBook(){

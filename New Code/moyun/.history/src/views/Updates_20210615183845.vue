                    ...
                    <v-item v-for="(item, index) in blogDT" v-bind:key="index" >
                      <div>
                        <v-hover v-slot:default="{ hover }">
                          ...
                          >
                            <v-card-title
                            class="title font-weight-bold grey darken-2--text">
                              <v-icon
                                large
                                left
                                color="grey darken-2"
                            ...
                            <v-card-text class="headline font-italic grey--text">
                             <div class="textDisplay">{{item.content}}</div> 
                            </v-card-text>

                            <v-card-actions align="right">
                              <v-list-item class="grow">
                                <v-list-item-title class="title font-weight-bold grey darken-2" >{{item.author}}</v-list-item-title>

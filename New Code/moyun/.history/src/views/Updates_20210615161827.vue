  ...
  <div class="updates">
    ...
    <v-main >
      <v-container fluid >
        ...
        <v-row class="fill-height main" align="center" justify="center">

            <br>
            <br>
            <br>
            <v-tabs margin-top="70px" >
              <v-tab>日志</v-tab>
              <v-tab>书评</v-tab>
              ...
              <v-tab-item >
                ...
                <br>
                <br>
                <v-lazy class="bkColor">
                  <v-container class="bkColor" >
                    <v-col class="bkColor" align="center" justify="center" >
    ...
    >
      ...
      <v-btn
        ...
        color="indigo"
      >
        <v-icon v-on:click="changeToBook">mdi-comment-bookmark</v-icon>
      </v-btn>
      <v-btn
        fab
        dark
        ...
        color="red"
      >
        <v-icon v-on:click="toBlock">mdi-account-circle</v-icon>
      </v-btn>
    </v-speed-dial>
        </v-container>          
      </v-container>
